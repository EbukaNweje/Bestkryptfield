...
const Landing5 = () => {
    return (
        <Container>
            <Wrapper>
                <Right>
                    <h1 style={{ color: "#012C6D", fontSize: "30px" }}>LONG-TERM ASSETS</h1>
                    <p style={{ color: "grey", fontSize: "20px" }}>We operate long-term assets and businesses across the globe. This approach dictates both our investment strategy and our commitment to environmental, social and governance (ESG) practices.</p>
